...
// 原 bot_upgrade/core_upgrade 共享的 Release API 类型
pub use network::release_api::{parse_digest, parse_sha256_manifest, extract_sha256_from_body, fetch_json_from_mirrors};
